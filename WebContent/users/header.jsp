		...
		<td width="1004" height="38" align="center" valign="middle">
			<table border="0" cellpadding="0" cellspacing="0" id="sddm">
				<tr>
					...
					<td align="left">
						<table width="100" border="0" cellpadding="0" cellspacing="0" background="themes/nzblue/images/nzcms/nzcms.07.gif">
							<tr>
								<td height="38" align="center"><a href="index/jobs.action" class="left">职位招聘</a></td>
							</tr>
						</table> <!--导航 -->
					</td>
					<td align="left">
						<table width="100" border="0" cellpadding="0" cellspacing="0" background="themes/nzblue/images/nzcms/nzcms.07.gif">
							<tr>
								<td height="38" align="center"><a href="index/bbs.action" class="left">留言板</a></td>
							</tr>
						</table> <!--导航 -->
					</td>
									...
									<table border="0" cellpadding="0" cellspacing="0" class="top01"
										...
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left"><a href="index/myAttend.action"><font class="p14"><img
																	src="themes/nzblue/images/biao.gif" alt="图标" border="0">&nbsp;我的考勤</font> </a></td>
													</tr>
												</table>
											</td>
										</tr>
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left"><a href="index/myReward.action"><font class="p14"><img
																	src="themes/nzblue/images/biao.gif" alt="图标" border="0">&nbsp;我的奖惩</font> </a></td>
													</tr>
												</table>
											</td>
										</tr>
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left"><a href="index/myTraining.action"><font class="p14"><img
																	src="themes/nzblue/images/biao.gif" alt="图标" border="0">&nbsp;我的培训</font> </a></td>
													</tr>
												</table>
											</td>
										</tr>
										<tr>
											<td align=left>
												<table width="100" height="35" border="0" cellpadding="0">
													<tr>
														<td align="left"><a href="index/mySalary.action"><font class="p14"><img
																	src="themes/nzblue/images/biao.gif" alt="图标" border="0">&nbsp;我的薪资</font> </a></td>
													</tr>
												</table>
											</td>
										</tr>
