...
<body>
	<nav class="breadcrumb">
		...
		新增员工考勤 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="attend/createAttend.action" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="attend/addAttend.action" name="myform" method="post">
			<div class="row cl">
