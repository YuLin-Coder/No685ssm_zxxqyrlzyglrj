...
<body>
	<nav class="breadcrumb">
		...
		留言回复查询 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="5">留言回复查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${rebbsList}" var="rebbs">
				<tr class="text-c">
					<td class="center">${rebbs.username}</td>
					<td class="center">${rebbs.title}</td>
					<td class="center">${rebbs.contents}</td>
					<td class="center">${rebbs.addtime}</td>
				</tr>
			</c:forEach>
		</table>
