...
<script type="text/javascript" src="js/ajaxuser.js" charset="utf-8"></script>
...
<body>
	<nav class="breadcrumb">
		...
		新增员工薪资 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="salary/createSalary.action" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="salary/addSalary.action" name="myform" method="post">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="basic" class="input-text" id="basic" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">考勤工资</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="attend" class="input-text" id="attend" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">奖惩工资</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="reward" class="input-text" id="reward" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">其他工资</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="others" class="input-text" id="others" placeholder="请输入其他工资" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">年月</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="yearx" class="input-text" id="yearx" value="${yearx }" readonly="readonly" />
				</div>
			</div>
			<div class="row cl">
