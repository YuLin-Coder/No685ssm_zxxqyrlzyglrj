	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="training/addTraining.action" name="myform"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="thestart" class="input-text" id="thestart" onclick="WdatePicker()" readonly="readonly"
						placeholder="请输入开始日期" />
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="theend" class="input-text" id="theend" onclick="WdatePicker()" readonly="readonly"
						placeholder="请输入结束日期" />
				</div>
			</div>
			<div class="row cl">
